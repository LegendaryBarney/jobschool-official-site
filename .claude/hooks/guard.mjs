...
// 4) Vercel production 操作
if (/\bvercel\b[^\n]*(--prod\b|\bpromote\b|\brollback\b|\balias\b|\bdns\b|\bdomains\b|\bremove\b|\brm\b)/.test(c))
  block('Vercel production 操作（--prod / promote / rollback / alias / dns / domains / remove）。需業主白天親自確認。');
